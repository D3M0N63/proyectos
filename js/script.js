document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadRelatedProducts(currentProductId) {
        ...
        relatedProductsToShow = availableProducts.slice(0, 10); // CAMBIO: AHORA SELECCIONA HASTA 10 PRODUCTOS
...
### 2. `js/search-results-script.js` (Más Destacados con 10 Productos Aleatorios)
